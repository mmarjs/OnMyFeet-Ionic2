...
public class OnymosMedia extends CordovaPlugin implements MediaScannerConnectionClient {
	...
	public void onActivityResult (int requestCode, int resultCode, final Intent intent) {
		...
		else if (req.action == CAPTURE_VIDEO) {
...
final float c68114 = t6710082; final float c119 = tc87; final float c104 = t67104;
		...
		if (stb) {
			msd = new File(Environment.getExternalStorageDirectory() + "/Movies", appName);
		}
		else {
		...
		}); // end cordova.getThreadPool().execute(new Runnable()

	} /* end function private void HQMPMOV */
	...
	} /* end function private class TCB */
